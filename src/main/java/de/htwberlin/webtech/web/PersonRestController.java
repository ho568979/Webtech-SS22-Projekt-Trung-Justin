...
public class PersonRestController {
    ...
    public ResponseEntity<Void> createPerson(@RequestBody PersonCreateOrUpdateRequest request) throws URISyntaxException {
    ...
    public ResponseEntity<Person> updatePerson(@PathVariable Long id, @RequestBody PersonCreateOrUpdateRequest request) {
